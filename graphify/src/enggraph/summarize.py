"""Backfill pass: `python -m enggraph.summarize`.
...
def describe_project(
    ...
    from enggraph.indexer import SUMMARY_HEAD_LINES
...
def main() -> None:
    ...
    if args.project:
        ...
        from enggraph.indexer import resolve_project
